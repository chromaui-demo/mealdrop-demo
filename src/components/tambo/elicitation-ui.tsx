...
function isSingleEntryMode(request: TamboElicitationRequest): boolean {
  const fields = Object.entries(request.requestedSchema.properties) as [string, FieldSchema][]
...
export const ElicitationUI: React.FC<ElicitationUIProps> = ({ request, onResponse, className }) => {
  ...
  const fields = useMemo(
    () => Object.entries(request.requestedSchema.properties) as [string, FieldSchema][],
