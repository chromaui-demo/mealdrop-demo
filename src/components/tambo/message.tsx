...
const ToolcallInfo = React.forwardRef<HTMLDivElement, ToolcallInfoProps>(
  ({ className, markdown = true, ...props }, ref) => {
    ...
    const toolCallRequest: TamboAI.ToolCallRequest | undefined = getToolCallRequest(message)
    ...
    return (
      ...
      >
        <div className="flex flex-col w-full">
          ...
          >
            <span className="whitespace-pre-wrap pl-2">tool: {toolCallRequest?.toolName}</span>
    ...
    <div className="flex flex-col gap-1">
      ...
      <div
        ...
        className={cn(
          ...
          isExpanded ? 'max-h-96 opacity-100 overflow-auto' : 'max-h-0 opacity-0 overflow-hidden'
        )}
...
function formatToolResult(
  ...
  if (contentString) {
    try {
      ...
      return <Streamdown components={markdownComponents}>{contentString}</Streamdown>
    }
  }
